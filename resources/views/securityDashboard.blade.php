<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight"> {{ __('Dashboard for security admin portal') }}
        </h2>
    </x-slot>
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200"> You're logged in as a Security administrator! </div>
            </div>
            <!-- <div class="sm:hidden">
                    ...
                    <table class="min-w-full">
                        ...
                        <tbody class="bg-white"> @for($i = 0; $i < count($data); $i++) <tr>
                                ...
                                <td
                                    ...
                                    </span>@endif @if($data[$i]['security'] =='approved') <span
                                        class="relative inline-block px-3 py-1 font-semibold text-green-900 leading-tight">
                                        <span aria-hidden
                                            class="absolute inset-0 bg-green-200 opacity-50 rounded-full"></span>
                                        <span class="relative text-xs">{{ $data[$i]['security'] }}</span>
                                    </span>@endif @if($data[$i]['security'] =='declined') <span
                                        class="relative inline-block px-3 py-1 font-semibold text-green-900 leading-tight">
                                        <span aria-hidden
                                ...
                                <td
                                    ...
                                    <a href="update-status/{{ $data[$i]['id'] }}/security/approved"><button
                                ...
                                <td
                                    class="px-6 py-4 whitespace-no-wrap text-right border-b border-gray-500 text-sm leading-5">
                                    <a href="update-status/{{ $data[$i]['id'] }}/security/declined"> <button
